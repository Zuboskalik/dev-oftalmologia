<?php namespace App\Http\Controllers;
	...
	class AdminVideosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"URL","name"=>"video", "callback"=>
														function($row)
																{
																	//dd($row->attach;);
			...
			$this->col[] = ["label"=>"Скопировать ссылку","name"=>"video",
											...
											function($row)
													{
														//dd($row->attach;);
														return "<button class=\"copyURLButton\" data-url=\"".$row->video."\">Скопировать ссылку</button>";//$row->attach;
													}];
			...
			$this->form[] = ['label'=>'Видео','name'=>'video','type'=>'upload','validation'=>'required|mimes:avi,mp4','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'URL','name'=>'URL','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Video','name'=>'video','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
	        ...
	        */
	        $this->load_js = array();
					$this->load_js[] = asset("js/VideosController.js");
