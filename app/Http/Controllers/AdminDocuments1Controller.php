<?php namespace App\Http\Controllers;
	...
	class AdminDocuments1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Скопировать ссылку на документ","name"=>"attach",
											...
											function($row)
													{
														//dd($row->attach;);
														return "<button class=\"copyURLButton\" data-url=\"".$row->attach."\">Копировать ссылку</button>";//$row->attach;
													}];
			...
			//$this->form[] = ['label'=>'Прикрепленный документ','name'=>'attach','type'=>'upload','validation'=>'required','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'&nbsp;','name'=>'checkbox_show_about','type'=>'checkbox','width'=>'col-sm-10','dataenum'=>' Отображать на стр. "О нас"'];
			# OLD END FORM
	        ...
	        */
	        $this->load_js = array();
					$this->load_js[] = asset("js/Documents1Controller.js");
