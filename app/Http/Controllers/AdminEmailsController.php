<?php namespace App\Http\Controllers;
	...
	class AdminEmailsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Адрес эл.почты","name"=>"email"];
			...
			$this->form[] = ['label'=>'Адрес эл.почты','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:emails','width'=>'col-sm-10','placeholder'=>'Введите корректный EMail-адрес'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:emails","placeholder"=>"Please enter a valid email address"];
			# OLD END FORM
